...
Value *CodeGenFunction::EmitAssignerBuiltinExpr(unsigned int BuiltinID,
  ...
  case assigner::BI__builtin_assigner_pallas_curve_init: {
    ID = Intrinsic::assigner_curve_init;
    auto Curve =
        llvm::EllipticCurveType::get(context, llvm::ELLIPTIC_CURVE_PALLAS);
    auto BaseField =
        llvm::GaloisFieldType::get(context, llvm::GALOIS_FIELD_PALLAS_BASE);
    OverloadTypes = {Curve, BaseField};
    break;
  }
  case assigner::BI__builtin_assigner_vesta_curve_init: {
    ID = Intrinsic::assigner_curve_init;
    auto Curve =
        llvm::EllipticCurveType::get(context, llvm::ELLIPTIC_CURVE_VESTA);
    auto BaseField =
        llvm::GaloisFieldType::get(context, llvm::GALOIS_FIELD_VESTA_BASE);
    OverloadTypes = {Curve, BaseField};
    break;
  }
  case assigner::BI__builtin_assigner_bls12381_curve_init: {
    ID = Intrinsic::assigner_curve_init;
    auto Curve =
        llvm::EllipticCurveType::get(context, llvm::ELLIPTIC_CURVE_BLS12381);
    auto BaseField =
  ...
  case assigner::BI__builtin_assigner_curve25519_curve_init: {
    ID = Intrinsic::assigner_curve_init;
    auto Curve =
  ...
  case assigner::BI__builtin_assigner_bit_composition: {
    ID = Intrinsic::assigner_bit_composition;
    auto ElemTy = llvm::GaloisFieldType::get(context,
                                             llvm::GALOIS_FIELD_PALLAS_BASE);
  ...
  case assigner::BI__builtin_assigner_fri_lin_inter: {
    ID = Intrinsic::assigner_fri_lin_inter;
    auto BaseField =
        llvm::GaloisFieldType::get(context, llvm::GALOIS_FIELD_PALLAS_BASE);
  ...
  case assigner::BI__builtin_assigner_permutation_arg_verifier: {
    ID = Intrinsic::assigner_permutation_arg_verifier;
    auto BaseField =
        llvm::GaloisFieldType::get(context, llvm::GALOIS_FIELD_PALLAS_BASE);
    auto Vec2Ty = llvm::FixedVectorType::get(BaseField, 2);
    auto Vec3Ty = llvm::FixedVectorType::get(BaseField, 3);
