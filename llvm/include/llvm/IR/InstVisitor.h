...
#include "llvm/IR/Instruction.def"
  ...
  RetTy visitIToGFInst(IToGFInst &I)              { DELEGATE(CastInst);}
  ...
  RetTy visitCMulInst(CMulInst & I)            { DELEGATE(Instruction); }
  RetTy visitCDivInst(CDivInst & I)            { DELEGATE(Instruction); }
