...
namespace llvm {
  ...
  public:
    enum SimpleValueType : uint8_t {
      ...
      // TVM local begin
      i256           =   10,  // This is a tvm 256 bit integer value
      i257           =   11,  // This is a tvm 257 bit signed integer value

      FIRST_INTEGER_VALUETYPE = i1,
      LAST_INTEGER_VALUETYPE  = i257,

      bf16           =  12,   // This is a 16 bit brain floating point value
      f16            =  13,   // This is a 16 bit floating point value
      f32            =  14,   // This is a 32 bit floating point value
      f64            =  15,   // This is a 64 bit floating point value
      f80            =  16,   // This is a 80 bit floating point value
      ...
      v32i16         =  52,   //  32 x i16
      v64i16         =  53,   //  64 x i16
      v128i16        =  54,   // 128 x i16
      v256i16        =  55,   // 256 x i16
      v512i16        =  56,   // 512 x i16
      ...
      v32i32         =  70,   //   32 x i32
      v64i32         =  71,   //   64 x i32
      v128i32        =  72,   //  128 x i32
      v256i32        =  73,   //  256 x i32
      v512i32        =  74,   //  512 x i32
      v1024i32       =  75,   // 1024 x i32
      v2048i32       =  76,   // 2048 x i32
      ...
      v32i64         =  83,   //  32 x i64
      v64i64         =  84,   //  64 x i64
      v128i64        =  85,   // 128 x i64
      v256i64        =  86,   // 256 x i64
      ...
      v32f16         =  94,   //   32 x f16
      v64f16         =  95,   //   64 x f16
      v128f16        =  96,   //  128 x f16
      v256f16        =  97,   //  256 x f16
      v512f16        =  98,   //  512 x f16

      v2bf16         =  99,   //    2 x bf16
      v3bf16         = 100,   //    3 x bf16
      v4bf16         = 101,   //    4 x bf16
      v8bf16         = 102,   //    8 x bf16
      v16bf16        = 103,   //   16 x bf16
      v32bf16        = 104,   //   32 x bf16
      v64bf16        = 105,   //   64 x bf16
      v128bf16       = 106,   //  128 x bf16
      ...
      v32f32         = 120,   //   32 x f32
      v64f32         = 121,   //   64 x f32
      v128f32        = 122,   //  128 x f32
      v256f32        = 123,   //  256 x f32
      v512f32        = 124,   //  512 x f32
      v1024f32       = 125,   // 1024 x f32
      v2048f32       = 126,   // 2048 x f32
      ...
      v32f64         = 133,   //   32 x f64
      v64f64         = 134,   //   64 x f64
      v128f64        = 135,   //  128 x f64
      v256f64        = 136,   //  256 x f64
      ...
      TVMSlice       = 198,    // TVM's slice type
      TVMBuilder     = 199,    // TVM's builder type
      TVMCell        = 200,    // TVM's cell type
      TVMTuple       = 201,    // TVM's tuple type
