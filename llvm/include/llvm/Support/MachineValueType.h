...
namespace llvm {
  ...
  public:
    enum SimpleValueType : uint8_t {
      ...
      v32i32         =  66,   //   32 x i32
      v64i32         =  67,   //   64 x i32
      v128i32        =  68,   //  128 x i32
      v256i32        =  69,   //  256 x i32
      v512i32        =  70,   //  512 x i32
      v1024i32       =  71,   // 1024 x i32
      v2048i32       =  72,   // 2048 x i32
      ...
      v32i64         =  79,   //  32 x i64
      v64i64         =  80,   //  64 x i64
      v128i64        =  81,   // 128 x i64
      v256i64        =  82,   // 256 x i64
      ...
      v32f16         =  90,   //   32 x f16
      v64f16         =  91,   //   64 x f16
      v128f16        =  92,   //  128 x f16
      v256f16        =  93,   //  256 x f16
      v512f16        =  94,   //  512 x f16

      v2bf16         =  95,   //    2 x bf16
      v3bf16         =  96,   //    3 x bf16
      v4bf16         =  97,   //    4 x bf16
      v8bf16         =  98,   //    8 x bf16
      v16bf16        =  99,   //   16 x bf16
      v32bf16        =  100,   //   32 x bf16
      v64bf16        =  101,   //   64 x bf16
      v128bf16       = 102,   //  128 x bf16
      ...
      v32f64         = 125,   //   32 x f64
      v64f64         = 126,   //   64 x f64
      v128f64        = 127,   //  128 x f64
      v256f64        = 128,   //  256 x f64
      ...
      TVMSlice       = 190,    // TVM's slice type
      TVMBuilder     = 191,    // TVM's builder type
      TVMCell        = 192,    // TVM's cell type
      TVMTuple       = 193,    // TVM's tuple type
