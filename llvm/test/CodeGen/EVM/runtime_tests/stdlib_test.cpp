...
[[evm]] int test_memset(int a) {
  __uint256_t val;
  auto p = memset(&val, 0xab, sizeof(val));
...
// Evmone doesn't support call instructions, while `modpow` builtin leverages
// precompiled contract. TODO: fix it
